        ...
        if (response.data.Status) {
          ...
          switch (status) {
            case 'pending':
              ...
              break;
            case 'fulfilled':
              toast.success(`Leave status updated to ${status}.`, { style: { backgroundColor: '#4caf50', color: '#fff' }, autoClose: 2000 });
              break;
            case 'rejected':
              toast.error(`Leave status updated to ${status}.`, { style: { backgroundColor: '#f44336', color: '#fff' }, autoClose: 2000 });
              break;
            default:
