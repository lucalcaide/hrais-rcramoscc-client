...
const FilesDisciplinaryForm = () => {
  ...
  return (
    <div className='px-5 mt-3 employee' style={{ fontFamily: 'Montserrat' }}>
      ...
      {/* Display total disciplinary forms */}
      <div className="mt-1">
              ...
              <table className="table table-striped mt-3">
                <thead>
                  <tr>
                    ...
                    <th style={{ fontSize: '20px', fontWeight: 'bold', textAlign: 'left' }}>Disciplinary Form</th>
                ...
                <tbody>
                  {currentEmployees.map(e => (
                    <tr key={e.id}>
                      ...
                      <td style={{ fontSize: '20px', fontStyle: 'italic', textAlign: 'left', verticalAlign: 'middle' }}>{e.disciplinary_form}</td>
