    ...
    <div className='d-flex justify-content-center align-items-center vh-100'>
      <div className='card p-5 shadow-sm custom-shadow' style={{ maxWidth: '600px', width: '100%' }}>
        <div className="text-center mb-4">
          <h2 className='mt-3 mb-3' style={{ fontSize: '28px', fontWeight: 'bold', fontFamily: 'Montserrat', color: '#0b283b' }}>Register New Admin</h2>
          <p style={{ fontSize: '20px', fontFamily: 'Montserrat', color: '#666' }}>
            Create a new <span style={{ fontWeight: 'bold' }}>admin</span> account by filling in the details below.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button className='btn btn-primary w-100 mb-3' style={{ fontSize: '22px', fontFamily: 'Montserrat', backgroundColor: '#0b283b', border: 'none' }}>Create Admin</button>
        </form>
